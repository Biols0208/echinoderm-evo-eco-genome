...
perl /kmerDedup/kmerDedup/kmerDedup.pl -k ${prefix} -mpr 0.3 -mcv 30 -kmer ${mer_len} -o kmerdedup_mpr3 -f ${prefix}.format.fa -bam ${prefix}.keymer_map.bam -cov ${prefix}.cov.stat -s samtools -t ${cpu} -mode 2
